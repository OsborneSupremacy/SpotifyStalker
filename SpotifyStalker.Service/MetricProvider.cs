...
public class MetricProvider : IMetricProvider
{
    public IEnumerable<Metric> GetAll()
    {
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.570873488557712,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.599277129321089,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.470970145726742,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.0994802822153096,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.336753349461642,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.206046028536375,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 1,
            GlobalAverage = 0.190609224592878,
        ...
        yield return new()
        {
            ...
            NominalMin = 0,
            NominalMax = 250,
            GlobalAverage = 120.343345841821,
